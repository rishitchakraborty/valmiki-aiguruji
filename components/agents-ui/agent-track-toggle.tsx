  ...
  variants: {
    variant: {
      default: [
        ...
        'data-[state=on]:bg-amber-500/15 data-[state=on]:text-amber-600 dark:data-[state=on]:text-amber-400',
        'data-[state=on]:hover:bg-amber-500/20',
      ],
      outline: [
        ...
        'data-[state=on]:bg-amber-500/10 data-[state=on]:text-amber-600 dark:data-[state=on]:text-amber-400 data-[state=on]:border-amber-500/30',
        'data-[state=on]:hover:bg-amber-500/20 data-[state=on]:hover:border-amber-500/40',
        'dark:data-[state=on]:hover:bg-amber-500/20',
      ],
    },
  },
  defaultVariants: {
